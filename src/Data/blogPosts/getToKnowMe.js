...
export const getToKnowMe = {
  ...
  body: `
    ...
    <p>Born in South Korea, 1990. Spent a few years in Canada and Fiji, but properly landed in Australia in the early 2000s — post-Sydney Olympics, when Cathy Freeman was queen and the Harbour Bridge had a whole vibe going on.</p>
    ...
    <p>Fun fact: despite all the rough sports growing up, I never broke a bone — not once. That streak ended in my late 20s with boxing. I like to think I earned it.</p>
    ...
    <p>Yes, I play LoL.</p>
    <ul>
      <li>ADC main (Miss Fortune/Caitlyn)</li>
    ...
    <h3>Travel Vibes</h3>
    <p>Always scheming the next escape. Last big trip? 6 weeks in Europe:</p>
    <ul>
      <li>London</li>
      <li>Lake District (UK)</li>
      <li>Cologne & Munich for Oktoberfest</li>
      <li>Lisbon</li>
